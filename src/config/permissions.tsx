export const ALL_PERMISSIONS = {
    COMPANIES: {
        GET_PAGINATE: { method: "GET", apiPath: '/v1/api/companies', module: "COMPANIES" },
        CREATE: { method: "POST", apiPath: '/v1/api/companies', module: "COMPANIES" },
        UPDATE: { method: "PATCH", apiPath: '/v1/api/companies/:id', module: "COMPANIES" },
        DELETE: { method: "DELETE", apiPath: '/v1/api/companies/:id', module: "COMPANIES" },
    },
    JOBS: {
    ...
    PERMISSIONS: {
        GET_PAGINATE: { method: "GET", apiPath: '/v1/api/permissions', module: "PERMISSIONS" },
        CREATE: { method: "POST", apiPath: '/v1/api/permissions', module: "PERMISSIONS" },
        UPDATE: { method: "PATCH", apiPath: '/v1/api/permissions/:id', module: "PERMISSIONS" },
        DELETE: { method: "DELETE", apiPath: '/v1/api/permissions/:id', module: "PERMISSIONS" },
    },
    RESUMES: {
        GET_PAGINATE: { method: "GET", apiPath: '/v1/api/resumes', module: "RESUMES" },
        CREATE: { method: "POST", apiPath: '/v1/api/resumes', module: "RESUMES" },
        UPDATE: { method: "PATCH", apiPath: '/v1/api/resumes/:id', module: "RESUMES" },
        DELETE: { method: "DELETE", apiPath: '/v1/api/resumes/:id', module: "RESUMES" },
    },
    ROLES: {
